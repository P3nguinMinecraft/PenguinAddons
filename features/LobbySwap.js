...
export default function lobbySwap(location, swap){
    ...
    if(swaptoggle = true){
        ...
        ChatLib.chat(`&b[&cPenguin&6Addons&b]&r Lobby swapping to &e${swap}&r and back to &e${location}&r!`);
